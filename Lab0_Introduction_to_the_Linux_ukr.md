# Звіт виконання завдань лабораторної работи №0
...
### Завдання 23: Відсортувати файли в `sourcecode/` за їх розміром.  
  **Команда:**
  ...
  ```
 ![Опис зображення](Images/Lab1/task23.png)




### Завдання 24: Пошук  файлів

Знайти всі файли у ~/ex0, імена яких закінчуються на .sv та які мають розмір більший за 5 Кілобайт.

**Команда:**  
```bash
find ~/ex0 -name '*.sv' -size +5k
```
![Опис зображення](Images/Lab1/task24.png)
...
![Опис зображення](Images/Lab1/task28.png)

![Опис зображення](Images/Lab1/task28_1.png)
...
![Опис зображення](Images/Lab1/task29.png)
...
![Опис зображення](Images/Lab1/task30.png)
...
![Опис зображення](Images/Lab1/task31.png)
...
![Опис зображення](Images/Lab1/task32.png)
...
![Опис зображення](Images/Lab1/task33.png)
