...
Завдання для студента 8 (Перетворення ваг): Перетворіть ваги до інтервалу [0, 255] використовуючи арифметичне округлення та вставте значення в Таблицю 1. Якою повинна бути сума цілочисельних ваг?
